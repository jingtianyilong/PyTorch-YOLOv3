...
parser.add_argument('--weights_path', type=str, default='/Users/zijieguo/doc/Jetson_TX2/darknet/yolov3.weights', help='path to weights file')
...
# there's also a train mode, this affect BN and Dropout
...
for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
    ...
    with torch.no_grad():
        ...
        # 方法被调用，这个方法的返回值将被赋值给as后面的变量。当with后面的代码块全部被执行完之后，将调用前面返回对象
        # 的__exit__()方法。
